...
let categoriesObject = require('./webapis/categories.api._')
let suppliersObject = require('./webapis/suppliers.api._')
let productsObject = require('./webapis/products.api._')
let ordersObject = require('./webapis/orders.api._')
