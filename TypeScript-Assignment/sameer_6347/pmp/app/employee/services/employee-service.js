...
var EmployeeService = (function () {
    ...
    EmployeeService.prototype.getAll = function () {
        return this._http.get("http://localhost:8005/employees").map(function (res) { return res.json(); });
    };
    EmployeeService.prototype.getSingle = function (id) {
        console.log(id);
        return this._http.get("http://localhost:8005/employees/" + id).map(function (res) { return res.json(); });
    };
    ...
    EmployeeService.prototype.deleteRecord = function (id) {
        return this._http.delete("http://localhost:8005/employees/" + id).map(function (res) { return res; });
    };
